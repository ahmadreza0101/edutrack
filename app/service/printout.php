...
// Tentukan orientation: landscape jika menampilkan banyak data (kelas), portrait jika detail single
...
if (!empty($kelas)) {
    // Perbaiki query: hilangkan is_active karena kolom tersebut mungkin tidak ada
    ...
    // Perbaiki query: hilangkan is_active
